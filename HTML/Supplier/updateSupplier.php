<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
    {
        ...
        if($nameErr == "" && $phoneNoErr == "" && $addressErr == "") {  
            ...
            $sql = "UPDATE Supplier SET Supplier_name = '$name', Supplier_phoneno = $phoneNo, Supplier_address = '$address'
        ...
        <form method="post" aciton="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">    
            ...
            <div class="FlexC">
                <div class="NameandInputC">
                    ...
                    <input type="text" name="name" placeholder="Name" value="<?php echo $row["supplier_name"]; ?>">
                    <span class="error"> <?php echo $nameErr; ?> </span>  
                </div>
                <div class="NameandInputC">
                    <span class="inputName">Phone Number</span><br>
                    <input type="text" name="phoneNo" placeholder="Phone no" value="<?php echo $row["supplier_phoneno"]; ?>">
                    <span class="error"> <?php echo $phoneNoErr; ?> </span>  
                </div>
            </div>
            <div class="NameandInputCforAddress">
                <span class="inputName">Address</span><br>
                <input type="text" name="address" placeholder="Address" value="<?php echo $row["supplier_address"]; ?>">
